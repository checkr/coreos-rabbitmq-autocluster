...
ARG RABBITMQ_VERSION=3.6.6
ARG PLUGIN_BASE=v3.6.x
ARG AUTOCLUSTER_VERSION=0.6.1
ARG DELAYED_MESSAGE_VERSION=0.0.1
ARG MESSAGE_TIMESTAMP_VERSION=3.6.6
...
RUN chown rabbitmq /var/lib/rabbitmq/.erlang.cookie /var/lib/rabbitmq /usr/lib/rabbitmq
